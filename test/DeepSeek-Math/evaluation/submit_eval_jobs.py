...
configs = [
    {
        'output-dir': "/mnt/cache/luzimu/math_pretrain/results/DeepSeekMath-Base",
        'model-path': "/mnt/cache/luzimu/rlhf_math/models/deepseek-math-7b-base",
        'tokenizer-path': "/mnt/cache/luzimu/rlhf_math/models/deepseek-math-7b-base",
        'model-size': "7b",
        'overwrite': False,
        'use-vllm': True,
